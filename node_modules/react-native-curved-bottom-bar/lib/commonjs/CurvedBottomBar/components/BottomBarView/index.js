...
var _curvedView = require("../CurvedView/curvedView");
...
const BottomBarComponent = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const d = (0, _react.useMemo)(() => {
    return type === 'DOWN' ? (0, _pathDown.getPathDown)(maxWidth, getTabbarHeight, getCircleWidth, borderTopLeftRight, circlePosition) : (0, _pathUp.getPathUp)(maxWidth, getTabbarHeight + 30, getCircleWidth, borderTopLeftRight, circlePosition);
  ...
  const MyTabBar = (0, _react.useCallback)(props => {
    ...
    }, /*#__PURE__*/_react.default.createElement(_curvedView.CurvedViewComponent, {
      style: shadowStyle,
      width: maxWidth,
  ...
  const main = (0, _react.useMemo)(() => {
    return /*#__PURE__*/_react.default.createElement(Tab.Navigator, _extends({}, props, {
      ...
      var _e$props3, _e$props4, _e$props5;
      ...
      return /*#__PURE__*/_react.default.createElement(Tab.Screen, {
        key: e === null || e === void 0 ? void 0 : (_e$props4 = e.props) === null || _e$props4 === void 0 ? void 0 : _e$props4.name,
        name: e === null || e === void 0 ? void 0 : (_e$props5 = e.props) === null || _e$props5 === void 0 ? void 0 : _e$props5.name
